...
//В контруктор передается 4 цвета: первые два цвета используются для первичного градиента
//вторые два цвета используются для вторичного градиента
//цвет тени будет такой же как самый первый переданный цвет, чтобы он совпадал с цветом градиента
